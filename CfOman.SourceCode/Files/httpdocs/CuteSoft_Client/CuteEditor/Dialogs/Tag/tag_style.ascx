...
var OxO34f7=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO34f7[1],true)[OxO34f7[0]]=function (){if(event[OxO34f7[2]]){alert(element[OxO34f7[3]].cssText);} ;} ;
</script>
