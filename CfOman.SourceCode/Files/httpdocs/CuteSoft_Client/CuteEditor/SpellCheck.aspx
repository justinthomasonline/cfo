...
<script type="text/javascript">
var OxO31ca=["ua","userAgent","isOpera","opera","isSafari","safari","isGecko","gecko","isWinIE","msie","isMac","Mac","availWidth","dialogWidth","availHeight","dialogHeight"];var _Browser_TypeInfo=null;function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={};Ox4[OxO31ca[0]]=navigator[OxO31ca[1]].toLowerCase();Ox4[OxO31ca[2]]=(Ox4[OxO31ca[0]].indexOf(OxO31ca[3])>-1);Ox4[OxO31ca[4]]=(Ox4[OxO31ca[0]].indexOf(OxO31ca[5])>-1);Ox4[OxO31ca[6]]=(!Ox4[OxO31ca[2]]&&!Ox4[OxO31ca[4]]&&Ox4[OxO31ca[0]].indexOf(OxO31ca[7])>-1);Ox4[OxO31ca[8]]=(!Ox4[OxO31ca[2]]&&Ox4[OxO31ca[0]].indexOf(OxO31ca[9])>-1);Ox4[OxO31ca[10]]=navigator[OxO31ca[1]].indexOf(OxO31ca[11])!=-1;_Browser_TypeInfo=Ox4;} ;Browser__InitType();function Browser_IsWinIE(){return _Browser_TypeInfo[OxO31ca[8]];} ;try{if(Browser_IsWinIE()){top.moveTo((screen[OxO31ca[12]]-self[OxO31ca[13]])/2,(screen[OxO31ca[14]]-self[OxO31ca[15]])/2);} else {} ;} catch(x){} ;
</script>
