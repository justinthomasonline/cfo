<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCMS/Site.master" AutoEventWireup="true" CodeFile="HomeCultureEvents.aspx.cs" Inherits="HomeCultureEvents" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title titleborder">Home Culture Events</h4>
                        </div>
                        <div class="box-body">
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label runat="server" id="lblimage">Events Image (165 X 169)</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="EventDatetimeTextBox" onkeypress="return false;" autocomplete="off" runat="server" CssClass="form-control datetimepicker"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required Field" ControlToValidate="EventDatetimeTextBox" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
