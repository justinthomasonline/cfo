<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCMS/Site.master" AutoEventWireup="true" CodeFile="EventsAddEdit.aspx.cs" Inherits="AdminCMS_EventsAddEdit" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title titleborder">Events</h4>
                        </div>
                        <div class="box-body">
                            <div class="row">
